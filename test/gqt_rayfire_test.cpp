...
int main( int /* argc */, char** /* argv */ )
{
    ...
    result +=
        RUN_TEST( gqt_outside_face_rayfire_orient_exit );  // fire ray from point outside volume
                                                           // looking for exit intersections
    result +=
        RUN_TEST( gqt_outside_face_rayfire_orient_entrance );  // fire ray from point outside volume
