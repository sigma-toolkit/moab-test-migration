...
ErrorCode test_locator( SpatialLocator& sl, int npoints, double& cpu_time,
...
int main( int argc, char** argv )
{
    ...
    po.addOpt< int >(
        "candidateplaneset,c",
        "Candidate plane set (0=SUBDIVISION,1=SUBDIV_SNAP,2=VERTEX_MEDIAN,3=VERTEX_SAMPLE",
        &csints );
