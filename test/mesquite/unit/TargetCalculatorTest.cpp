...
class TargetCalculatorTest : public CppUnit::TestFixture
{
  ...
  public:
    ...
    template< unsigned R, unsigned C > static inline void check_valid_V( MsqMatrix< R, C > V );

    template< unsigned D > static inline void check_valid_Q( MsqMatrix< D, D > Q );

    template< unsigned D > static inline void check_valid_delta( MsqMatrix< D, D > delta );
};
...
template< unsigned D > inline void TargetCalculatorTest::check_valid_Q( MsqMatrix< D, D > Q )
{
