...
int main( int argc, char* argv[] )
{
    ...
    if( couComm != MPI_COMM_NULL )
    {
        ...
        ierr = iMOAB_ComputeScalarProjectionWeights(
            ...
            &fNoBubble, &fMonotoneTypeID, &fVolumetric, &fNoConserve, &fValidate, &sparseConstraints, dof_tag_names[0].c_str(), dof_tag_names[1].c_str(),
    ...
    if( couComm != MPI_COMM_NULL )
    {
        ...
        ierr = iMOAB_ComputeScalarProjectionWeights(
            ...
            disc_methods[2].c_str(), &disc_orders[2], &fNoBubble, &fMonotoneTypeID, &fVolumetric, &fNoConserve, &fValidate, &sparseConstraints,
