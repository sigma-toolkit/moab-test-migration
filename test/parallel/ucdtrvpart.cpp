...
void test_multiple_loads_of_same_file( )
{
    ...
    opts = "PARALLEL=READ_PART;PARTITION;PARALLEL_RESOLVE_SHARED_ENTS;PARTITION_METHOD=TRIVIAL;"
           "VARIABLE=";
    ...
    if( 2 == procs )
    {
        ...
        {
            CHECK_EQUAL( 5283,
                         my_num );  // Gather set vertices included; Not owned vertices included
            ...
            my_num = verts.size( );
            CHECK_EQUAL( 1825,
                         my_num );  // Gather set vertices excluded; Not owned vertices included
        }
