...
/**\brief Shape function space for trilinear quadahedron, obtained by a pushforward of the canonical
...
class LinearQuad
{
  public:
    ...
    {
        return EvalSet( evalFcn, reverseEvalFcn, normalFcn, jacobianFcn, integrateFcn, NULL,
                        insideFcn );
    }
