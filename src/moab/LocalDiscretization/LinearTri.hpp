...
/**\brief Shape function space for trilinear tetrahedron, obtained by a pushforward of the canonical
...
class LinearTri
{
  public:
    ...
    {
        return EvalSet( evalFcn, reverseEvalFcn, normalFcn, jacobianFcn, integrateFcn, initFcn,
                        insideFcn );
    }
