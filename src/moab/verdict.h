...
/*! \ref verdict "Verdict Mesh Quality Metrics" are available in the MOAB User's Guide.
    This library provides comprehensive mesh quality assessment capabilities for various element types.
*/
