...
inline HomCoord::HomCoord( const int coord0, const int coord1, const int coord2, const int coord3 )
{
    homCoord[ 0 ] = coord0;
    homCoord[ 1 ] = coord1;
    homCoord[ 2 ] = coord2;
...
inline HomCoord::HomCoord( const int coord0, const int coord1, const int coord2 )
{
    homCoord[ 0 ] = coord0;
    homCoord[ 1 ] = coord1;
    homCoord[ 2 ] = coord2;
...
inline void HomCoord::set( const int ip, const int jp, const int kp, const int hp )
{
    homCoord[ 0 ] = ip;
    homCoord[ 1 ] = jp;
    homCoord[ 2 ] = kp;
...
{
    return ( homCoord[ 0 ] == rhs1.homCoord[ 0 ] && homCoord[ 1 ] == rhs1.homCoord[ 1 ] &&
             homCoord[ 2 ] == rhs1.homCoord[ 2 ] && homCoord[ 3 ] == rhs1.homCoord[ 3 ] );
}
...
inline HomXform::HomXform( const int rotate[ 9 ], const int scale[ 3 ], const int translate[ 3 ] )
{
    int i, j;
    for( i = 0; i < 3; i++ )
    {
