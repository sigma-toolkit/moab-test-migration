...
class HigherOrderFactory
{
  public:
    ...
    ErrorCode convert( const EntityHandle meshset,
                       const bool mid_edge_nodes,
                       const bool mid_face_nodes,
                       const bool mid_volume_nodes );

    ErrorCode convert( const Range& entities,
                       const bool mid_edge_nodes,
                       const bool mid_face_nodes,
                       const bool mid_volume_nodes );
  ...
  private:
    ...
    //! entities that share those two corner nodes and have space allocated for mid-edge nodes are
    //! returned in a vector
    EntityHandle center_node_exist( EntityHandle corner1,
    ...
    bool add_center_node( EntityType type,
