...
//! constructor
ScdVertexData::ScdVertexData( const EntityHandle start_vertex, const int imin, const int jmin,
...
SequenceData* ScdVertexData::subset( EntityHandle /*start*/, EntityHandle /*end*/,
