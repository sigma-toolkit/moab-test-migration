#ifndef QUADRATIC_QUAD_HPP
#define QUADRATIC_QUAD_HPP
  /**\brief Shape function space for biquadratic quad, obtained by a pushforward of the canonical linear (affine) functions. */
...
protected:
  ...
  static const int corner[9][2];
  static const double gauss[4][2];// TODO fix me
  static const unsigned int corner_count = 9;
  static const unsigned int gauss_count  = 4; // TODO fix me
