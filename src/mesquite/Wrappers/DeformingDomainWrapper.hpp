...
class DeformingDomainWrapper : public Wrapper
{
  public:
     ...
     */
    inline void set_initial_coord_tag( const std::string& tag_name )
    {
     ...
     */
    inline void set_mesh_characteristic( MeshCharacteristic t )
    {
        metricType = t;
    }
    ...
    inline void set_cpu_time_limit( double seconds )
    {
        cpuTime = seconds;
    }
    ...
    inline bool get_cpu_time_limit( double& seconds ) const
    {
        seconds = cpuTime;
        return cpuTime > 0.0;
    }
...
class DeformingCurveSmoother
{
  public:
     ...
     */
    inline void set_initial_fraction_tag( const std::string& tag_name )
    {
    ...
    /**\brief Specify which mesh characteristics to preserve */
    inline void set_mesh_characteristic( Scheme t )
    {
        metricType = t;
    }
     ...
     */
    MESQUITE_EXPORT
    void store_initial_mesh( Mesh* mesh_instance, const Mesh::VertexHandle* vertex_array,
                             int vertex_array_length, CurveDomain* geometry, MsqError& err );
     ...
     */
    MESQUITE_EXPORT
    void smooth_curve( Mesh* mesh_instance, const Mesh::VertexHandle* vertex_array,
                       int vertex_array_length, CurveDomain* geometry, Scheme type, MsqError& err );
