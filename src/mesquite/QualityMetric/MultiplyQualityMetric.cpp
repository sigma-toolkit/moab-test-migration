...
MultiplyQualityMetric::MultiplyQualityMetric( QualityMetric* qm1, QualityMetric* qm2,
                                              MsqError& err )
...
void MultiplyQualityMetric::get_evaluations( PatchData& pd, std::vector< size_t >& handles,
                                                   ...
                                                   std::vector< size_t >& indices, MsqError& err )
{
    ...
    std::set_union( indices1.begin( ), indices1.end( ), indices2.begin( ), indices2.end( ),
