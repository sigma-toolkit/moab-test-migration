...
bool TShapeSize2DNB2::evaluate_with_grad( const MsqMatrix< 2, 2 >& T, double& result,
...
bool TShapeSize2DNB2::evaluate_with_hess( const MsqMatrix< 2, 2 >& T, double& result,
