...
void MeshDecorator::vertex_set_coordinates( VertexHandle vertex, const Vector3D& coordinates,
                                            MsqError& err )
{
...
void MeshDecorator::vertex_set_byte( VertexHandle vertex, unsigned char byte, MsqError& err )
{
...
void MeshDecorator::vertex_get_byte( const VertexHandle vertex, unsigned char* byte, MsqError& err )
{
    get_mesh( )->vertex_get_byte( vertex, byte, err );
}

void MeshDecorator::vertices_get_byte( const VertexHandle* vertex, unsigned char* byte_array,
...
void MeshDecorator::elements_get_attached_vertices( const ElementHandle*         elem_handles,
                                                    ...
                                                    std::vector< size_t >& offsets, MsqError& err )
{
    get_mesh( )->elements_get_attached_vertices( elem_handles, num_elems, vert_handles, offsets,
                                                 err );
}
...
{
    get_mesh( )->elements_get_topologies( element_handle_array, element_topologies, num_elements,
                                          err );
}
...
void MeshDecorator::tag_properties( TagHandle handle, std::string& name_out, TagType& type_out,
                                    unsigned& length_out, MsqError& err )
{
    get_mesh( )->tag_properties( handle, name_out, type_out, length_out, err );
}

void MeshDecorator::tag_set_element_data( TagHandle handle, size_t num_elems,
...
void MeshDecorator::tag_set_vertex_data( TagHandle handle, size_t num_elems,
...
void MeshDecorator::tag_get_element_data( TagHandle handle, size_t num_elems,
...
void MeshDecorator::tag_get_vertex_data( TagHandle handle, size_t num_elems,
...
void MeshDecorator::release_entity_handles( const EntityHandle* handle_array, size_t num_handles,
                                            MsqError& err )
{
