...
class MESQUITE_EXPORT ParallelMeshImpl : public ParallelMesh
{
  public:
    ...
    void vertices_set_global_id( const VertexHandle vert_array[], size_t gid[], size_t num_vtx,
                                 MsqError& err );

    void vertices_set_processor_id( const VertexHandle vert_array[], int pid[], size_t num_vtx,
                                    MsqError& err );
    ...
    void vertices_set_fixed_flag( const VertexHandle vert_array[], const bool fixed_flag_array[],
                                  size_t num_vtx, MsqError& err );
