...
void MBMesquite::XYPlanarDomain::element_normal_at(
    MBMesquite::Mesh::ElementHandle /*entity_handle*/, MBMesquite::Vector3D& coordinate ) const
{
    coordinate = Vector3D( 0.0, 0.0, 1.0 );
}
...
void MBMesquite::XYPlanarDomain::domain_DoF( const Mesh::VertexHandle*, unsigned short* dof_array,
