...
inline void MsqHessian::apply_preconditioner( Vector3D zloc[], Vector3D rloc[], MsqError& /*err*/ )
{
    ...
    for( m = 0; m < mSize; ++m )
    {
        ...
        zloc[ m ][ 2 ] = rloc[ m ][ 2 ] - mPreconditioner[ m ][ 0 ][ 2 ] * zloc[ m ][ 0 ] -
                         mPreconditioner[ m ][ 1 ][ 2 ] * zloc[ m ][ 1 ];
        ...
        zloc[ m ][ 0 ] = zloc[ m ][ 0 ] - mPreconditioner[ m ][ 0 ][ 1 ] * zloc[ m ][ 1 ] -
                         mPreconditioner[ m ][ 0 ][ 2 ] * zloc[ m ][ 2 ];
#endif
    }
}
