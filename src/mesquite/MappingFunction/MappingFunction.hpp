...
class MESQUITE_EXPORT MappingFunction
{
  public:
     ...
     */
    virtual void coefficients( Sample location, NodeSet nodeset, double* coeff_out,
                               size_t* indices_out, size_t& num_coeff_out,
    ...
    static inline void convert_connectivity_indices( EntityTopology topology,
                                                     ...
                                                     size_t* index_list, unsigned num_indices,
                                                     MsqError& err );
                                              ...
                                              MsqError& err ) const
    {
        convert_connectivity_indices( element_topology( ), num_nodes( ),
                                      num_nodes_in_output_element_type, index_list, num_indices,
                                      err );
    }
...
class MESQUITE_EXPORT MappingFunction2D : public MappingFunction
{
  public:
     ...
     */
    virtual void jacobian( const PatchData& pd, size_t element_number, NodeSet nodeset,
...
inline void MappingFunction::convert_connectivity_indices( EntityTopology topo, int input_type,
                                                           ...
                                                           unsigned num_indices, MsqError& err )
{
    ...
    if( input_type != output_type && input_type != num_corners && output_type != num_corners )
        convert_connectivity_indices_impl( topo, input_type, output_type, index_list, num_indices,
                                           err );
}
