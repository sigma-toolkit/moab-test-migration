...
class VarLenDenseTag : public TagInfo
{
  ...
  public:
    static VarLenDenseTag* create_tag( SequenceManager* seqman,
                                       Error* error_handler,
                                       const char* name,
                                       DataType type,
                                       const void* default_value,
  ...
  private:
     ...
     */
    inline ErrorCode get_array( SequenceManager* seqman,
                                Error* error_handler,
                                EntityHandle h,
                                VarLenTag*& ptr,
                                size_t& count,
     ...
     *               or not any tag storage is allocated).
     */
    inline ErrorCode get_array( const SequenceManager* seqman,
                                Error* error_handler,
                                EntityHandle h,
                                const VarLenTag*& ptr,
                                size_t& count ) const;
     ...
     *                 corresponding value
     */
    inline ErrorCode set_data( SequenceManager* seqman,
                               Error* error_handler,
                               const EntityHandle* entities,
                               size_t num_entities,
                               bool one_value,
