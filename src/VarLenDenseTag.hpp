...
class VarLenDenseTag : public TagInfo
{
  ...
  public:
    static VarLenDenseTag* create_tag( SequenceManager* seqman, Error* error_handler,
                                       const char* name, DataType type, const void* default_value,
                                       int default_value_len );
     ...
     *                search is restricted to entities in this list.
     */
    virtual ErrorCode find_entities_with_value( const SequenceManager* seqman, Error* error,
  ...
  private:
     ...
     */
    inline ErrorCode get_array( SequenceManager* seqman, Error* error_handler, EntityHandle h,
     ...
     *                 corresponding value
     */
    inline ErrorCode set_data( SequenceManager* seqman, Error* error_handler,
                               const EntityHandle* entities, size_t num_entities, bool one_value,
     ...
     *                 corresponding value
     */
    inline ErrorCode set_data( SequenceManager* seqman, Error* error_handler, const Range& entities,
                               bool one_value, void const* const* pointers, const int* lengths );
};
