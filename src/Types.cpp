...
const char* const moab::ErrorCodeStr[] = { "MB_SUCCESS",
...
const char* const moab::DataTypeStr[] = { "MB_TYPE_OPAQUE", "MB_TYPE_INTEGER", "MB_TYPE_DOUBLE",
                                          "MB_TYPE_BIT", "MB_TYPE_HANDLE" };

const char* const SenseTypeStr_private[] = { "SENSE_INVALID", "SENSE_REVERSE", "SENSE_BOTH",
                                             "SENSE_FORWARD" };
