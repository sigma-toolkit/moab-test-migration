...
ErrorCode TempestRemapper::DefineAnalyticalSolution ( moab::Tag& solnTag, const std::string& solnName,
                                                ...
                                                std::string cloneSolnName)
{
  ...
  switch(ctx)
  {
    case Remapper::SourceMesh:
      meshset = m_covering_source_set;
      trmesh = m_covering_source;
      entities = (point_cloud_source ? m_covering_source_vertices : m_covering_source_entities);
      break;

    case Remapper::TargetMesh:
      meshset = m_target_set;
      trmesh = m_target;
      entities = (point_cloud_target ? m_target_vertices : m_target_entities);
      break;
  ...
  if (!discMethod.compare("cgll") || !discMethod.compare("dgll"))
  {
