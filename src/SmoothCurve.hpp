...
class SmoothCurve
{
  public:
    ...
    void compute_control_points_on_boundary_edges(
        double min_dot, std::map< EntityHandle, SmoothFace* >& mapSurfaces, Tag controlPointsTag,
        Tag markTag );

    ErrorCode evaluate_smooth_edge( EntityHandle eh, double& tt, CartVect& outv,
