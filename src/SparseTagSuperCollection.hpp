...
class SparseTagSuperCollection
{
  public:
     ...
     *                   first passed tag value.
     */
    ErrorCode set_data( TagId tag_handle, const Range& handles, void const* const* data_pointers,
                        const int* lengths = 0, bool one_value = false );
     ...
     */
    ErrorCode get_data( TagId tag_handle, const EntityHandle* handles, int num_handles, void* data,
     ...
     */
    ErrorCode get_data( TagId tag_handle, const Range& handles, const void** data, int* lengths,
                        const void* default_value, int default_value_length ) const;
