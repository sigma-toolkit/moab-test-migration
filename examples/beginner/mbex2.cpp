...
int main()
{
    ...
    MB_CHK_SET_ERR( mbint.load_file( "mbex1.vtk" ), "load_file failed" );
    ...
    MB_CHK_SET_ERR( mbint.get_entities_by_type( 0, moab::MBHEX, hex_range ), "get_entities_by_type(HEX) failed" );
    ...
    MB_CHK_SET_ERR( mbint.get_connectivity( &handle, 1, connectivity ), "get_connectivity failed" );
    ...
    {
        MB_CHK_SET_ERR( mbint.get_coords( &( *iter ), 1, coord ), "get_coords" );
    ...
    MB_CHK_SET_ERR( mbint.get_entities_by_type( 0, moab::MBVERTEX, vertex_range ),
    ...
    MB_CHK_SET_ERR( mbint.get_coords( vertex_range, vertex_coords.data() ), "get_coords" );
    ...
    MB_CHK_SET_ERR( mbint.set_coords( vertex_range, vertex_coords.data() ), "set_coords" );

    // **************************
    // *   Write Mesh to File   *
    // **************************
    MB_CHK_SET_ERR( mbint.write_file( "mbex2.vtk" ), "write_file(mbex2.vtk) failed" );
