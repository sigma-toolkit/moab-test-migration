...
# query the root set for all triangles
polyh = mb.get_entities_by_type(root_set, types.MBPOLYHEDRON, recur = True)
print("Found " + str(polys.size()) + " polyhedra in this model.")
...
gidsele = mb.tag_get_data(gidTag,polyh).reshape((polyh.size())) - 1
