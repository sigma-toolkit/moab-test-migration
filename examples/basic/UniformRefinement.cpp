...
int main(int argc, char* argv[]) {
    try {
        ...
        MB_CHK_SET_ERR_CONT(
            moab->load_file(input_file.c_str()),
            "Failed to load mesh file: " << input_file
        );
        ...
        MB_CHK_SET_ERR(
            refiner.generate_mesh_hierarchy(num_levels, level_degrees.data(), mesh_sets),
        ...
        MB_CHK_SET_ERR(
            moab->write_file(DEFAULT_OUTPUT_FILE),
