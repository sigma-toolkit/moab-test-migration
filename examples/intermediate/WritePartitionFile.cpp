...
int main( int argc, char** argv )
{
    ...
    rval =
        mb->get_entities_by_type_and_tag( 0, moab::MBENTITYSET, &part_set_tag, NULL, 1, tagged_sets, moab::Interface::UNION );MB_CHK_SET_ERR( rval, "Failed to get partition sets" );
