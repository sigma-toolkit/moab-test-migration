...
find_library( NETCDF_C_LIBRARY
    ...
    HINTS ${NETCDF_DIR}
    ${NETCDF_DIR}/lib/x86_64-linux-gnu
    ${NETCDF_DIR}/lib64
    ${NETCDF_DIR}/lib
    NO_DEFAULT_PATH
  )
  ...
  IF (NOT NETCDF_FOUND)
    if ( NETCDF_INCLUDE_DIR AND NETCDF_C_LIBRARY )
      ...
      if ( NETCDF_FORTRAN_LIBRARY )
        set(NETCDF_LIBRARIES ${NETCDF_FORTRAN_LIBRARY} ${NETCDF_LIBRARIES} )
...
find_package_handle_standard_args (NetCDF "NetCDF not found, check the CMake NETCDF_DIR variable"
