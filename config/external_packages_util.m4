...
AC_DEFUN([AUSCM_CONFIGURE_DOWNLOAD_TEMPESTREMAP],[
  ...
  m4_case( TEMPESTREMAP_DOWNLOAD_VERSION, [2.0.4], [ AUSCM_CONFIGURE_EXTERNAL_PACKAGE([TempestRemap], [https://github.com/ClimateGlobalChange/tempestremap/archive/v2.0.4.tar.gz], [$2] ) ],
                                  ...
                                  [ AUSCM_CONFIGURE_EXTERNAL_PACKAGE([TempestRemap], [https://github.com/ClimateGlobalChange/tempestremap/archive/v2.0.4.tar.gz], [$2] ) ] )
