...
#
# Original Author: Jed Brown
#   Downloaded From:
#     https://raw.githubusercontent.com/jedbrown/cmake-modules/master/ResolveCompilerPaths.cmake
# Modified by:     Vijay Mahadevan
#
macro (RESOLVE_LIBRARIES LIBS LINK_LINE)
  string (REGEX MATCHALL "((-L|-l)([^\" ]+|\"[^\"]+\")|/[^\" ]+(a|so|dylib|dll|lib))" _all_tokens "${LINK_LINE}")
  #message(" Found all tokens: ${_all_tokens}")
  set (_libs_found)
  set (_directory_list)
  foreach (token ${_all_tokens})
    ...
    elseif (token MATCHES "^(-l([^\" ]+|\"[^\"]+\")|/[^\" ]+(a|so|dylib|dll|lib))")
    ...
    elseif (token MATCHES "-Wl([^\" ]+|\"[^\"]+\")")
      # Possibly found an rpath flag
      # message ("Found rpath token = ${token}")
