...
define program_dependencies
	...
	$(top_srcdir)/config/fortran_dependencies.pl $p >> $@ || { rm $@; exit 1; }

endef

$(_f90_depfile): $(top_srcdir)/config/fortran_dependencies.pl $(foreach p,$(_f90_targets),$(_$p_use_mods) $(_$p_def_mods)) | $(foreach p,$(_f90_targets),$(_f90_depdir)/$p)
