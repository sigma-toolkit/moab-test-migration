...
class SimplexTemplateRefiner : public EntityRefiner
{
  ...
  protected:
    ...
    bool refine_1_simplex( int max_depth, const double* v0, const void* t0, EntityHandle h0,
                           const double* v1, const void* t1, EntityHandle h1 );
    bool refine_2_simplex( int max_depth, int move, const double* v0, const void* t0,
                           EntityHandle h0, const double* v1, const void* t1, EntityHandle h1,
                           const double* v2, const void* t2, EntityHandle h2 );
    bool refine_3_simplex( int max_depth, double* v0, void* t0, EntityHandle h0, double* v1,
    ...
    static bool compare_Hopf_cross_string_dist( const double* v00, const double* v01,
