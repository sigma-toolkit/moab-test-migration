...
class EdgeSizeSimpleImplicit : public EdgeSizeEvaluator
{
  public:
     ...
     */
    virtual bool evaluate_edge( const double* p0, const void* t0, double* p1, void* t1,
    ...
    /// Get the 10 coefficients of the implicit function. The vector contains the entries of A,
    /// followed by B, followed by C.
