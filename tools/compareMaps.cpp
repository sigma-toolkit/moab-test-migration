...
int main( int argc, char* argv[] )
{
    ...
    std::ofstream myDiffFile;
    myDiffFile.open( "map-var_S-diff.txt" );
    myDiffFile << diff.coeffs() << std::endl;
    // myDiffFile << diff.coeffs().format(column_transpose_format) << std::endl;
    myDiffFile.close();
#endif
