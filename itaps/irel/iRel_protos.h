...
#define iRel_setEntArrEntArrRelation \
    ITAPS_FC_WRAPPER( irel_setentarrentarrrelation, IREL_SETENTARRENTARRRELATION )
#define iRel_setSetArrEntArrRelation \
    ITAPS_FC_WRAPPER( irel_setsetarrentarrrelation, IREL_SETSETARRENTARRRELATION )
#define iRel_setEntArrSetArrRelation \
    ITAPS_FC_WRAPPER( irel_setentarrsetarrrelation, IREL_SETENTARRSETARRRELATION )
#define iRel_setSetArrSetArrRelation \
    ITAPS_FC_WRAPPER( irel_setsetarrsetarrrelation, IREL_SETSETARRSETARRRELATION )
...
#define iRel_getEntSetIterRelation \
    ITAPS_FC_WRAPPER( irel_getentsetiterrelation, IREL_GETENTSETITERRELATION )
#define iRel_getEntArrEntArrRelation \
    ITAPS_FC_WRAPPER( irel_getentarrentarrrelation, IREL_GETENTARRENTARRRELATION )
#define iRel_getEntArrSetArrRelation \
    ITAPS_FC_WRAPPER( irel_getentarrsetarrrelation, IREL_GETENTARRSETARRRELATION )
#define iRel_getSetArrEntArrRelation \
    ITAPS_FC_WRAPPER( irel_getsetarrentarrrelation, IREL_GETSETARRENTARRRELATION )
#define iRel_getSetArrSetArrRelation \
    ITAPS_FC_WRAPPER( irel_getsetarrsetarrrelation, IREL_GETSETARRSETARRRELATION )
...
#define iRel_inferAllRelationsAndType \
    ITAPS_FC_WRAPPER( irel_inferallrelationsandtype, IREL_INFERALLRELATIONSANDTYPE )
...
#define iRel_inferEntArrRelations \
    ITAPS_FC_WRAPPER( irel_inferentarrrelations, IREL_INFERENTARRRELATIONS )
#define iRel_inferSetArrRelations \
    ITAPS_FC_WRAPPER( irel_infersetarrrelations, IREL_INFERSETARRRELATIONS )
