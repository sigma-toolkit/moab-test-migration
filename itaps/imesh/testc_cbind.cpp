...
int entity_sets_subtest( iMesh_Instance mesh, int is_list, int /*num_iter*/ )
{
...
int vertex_tag_delete_test( iMesh_Instance mesh, iBase_EntityHandle* verts, int /*verts_size*/ )
{
    int result;
