...
class MsqIRel : public MsqCommonIGeom
{
  ...
  protected:
    ...
    int geom_from_mesh( Mesh::EntityHandle mesh_handle_in, iBase_EntityHandle& geom_handle_out,
                        int& geom_dimension_out ) const;

    int geom_from_mesh( Mesh::EntityHandle const* mesh_handles_in, iBase_EntityHandle* geom_handles_out,
                        unsigned short* geom_dimensions_out, size_t count ) const;
